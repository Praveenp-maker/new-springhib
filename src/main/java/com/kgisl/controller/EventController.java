...
import com.kgisl.entity.Ticket;
...
//     }
    ...
    String n=theCustomer.getEvent_name();
    System.out.println("********************************");
    ...
    public String showFormForUpdate1(@RequestParam("customerId") int theId,
        Model theModel) {
            theModel.addAttribute("ticket", new Ticket());
            System.out.println("enter the method");
    Event theCustomer = eventService.getCustomer(theId);
     ArrayList<Ticket> ticket1= new ArrayList<Ticket>(); 
    int event_name=theCustomer.getEvent_id();
    String m=theCustomer.getEvent_name();
    int o=theCustomer.getPrize();
    Ticket e1 = new Ticket();
    e1.setEvent_id(event_name);
    e1.setEvent_name(m);
    e1.setPrize(o);
    ticket1.add(e1);
    
    System.out.println("list is show ");
    System.out.println(ticket1);
    System.out.println("********************************");
   // System.out.println(n);
        theModel.addAttribute("ticket", ticket1);
        return "event-form1";
    }
